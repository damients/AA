...
public interface MyList<T>
{
     ...
     */
    public abstract void add(int index, T newValue) throws IndexOutOfBoundsException;
     ...
     * @throws IndexOutOfBoundsException In index are out of bounds.
     */
    public abstract int get(T index) throws IndexOutOfBoundsException;
     ...
     */
    public abstract boolean search(T value);
